...
//
uint8_t UARTDMA_GetLineFromReceiveBuffer(UARTDMA_HandlerTypeDef *huartdma, char *OutBuffer)
{
...
//
uint8_t UARTDMA_IsDataTransferReady(UARTDMA_HandlerTypeDef *huartdma)
{
